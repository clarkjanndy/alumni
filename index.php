                    ...
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item">
                          <div class=" dropdown mr-4">
                              <a href="#" class="nav-link js-scroll-trigger"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">About&nbsp;&nbsp;<i class="fa fa-angle-down"></i></a>
                                <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
                                  <a class="dropdown-item" href="index.php?page=about" id="manage_my_account"><i class="fa fa-about"></i> About Us</a>
                                  <a class="dropdown-item" href="index.php?page=officers" id="employment"><i class="fa fa-user"></i> List of Officers</a>
                                </div>
                          </div>
                        </li>
                        <?php if(!isset($_SESSION['login_id'])): ?>
                          ...
                          <div class=" dropdown mr-4">
                              <a href="#" class="nav-link js-scroll-trigger"  id="account_settings" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['login_name'] ?> <i class="fa fa-angle-down"></i></a>
                                <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
                                  ...
                                  <a class="dropdown-item" href="index.php?page=employment_status&&id=<?php echo $_SESSION['login_alumnus_id'];  ?>" id="employment"><i class="fa fa-plus"></i> Employment Status</a>
