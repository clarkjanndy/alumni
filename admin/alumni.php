					...
					<div class="card-body small">
						<table class="table table-condensed table-bordered table-hover">
							...
							<tbody>
								...
								$alumni = $conn->query("SELECT a.*,c.course,Concat(a.lastname,', ',a.firstname,' ',a.middlename) as name from alumnus_bio a inner join courses c on c.id = a.course_id WHERE a.status='0' AND a.course_id='".$view_courses['id']."' order by Concat(a.lastname,', ',a.firstname,' ',a.middlename) asc");
								...
								<?php endwhile; 
									...
									echo "<tr><td colspan='6' class='bg-primary  text-white'>".$view_courses['course']."</td></tr>";
										echo "<tr><td colspan='6' class='bg-gray'><div class='ml-4 pl-3'>No Alumni has registered yet</div></td></tr>";
								}
