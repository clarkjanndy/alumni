            ...
            <div class="container-fluid pt-2 bg-theme">
                ...
                <div class="card alumni-list" data-id="<?php echo $row['id'] ?>">
                        <div class="alumni-img" card-img-top>
                            ...
                            <img src="<?php echo $fpath.'/'.$row['avatar'] ?>" alt="" onerror="this.src='./assets/img/bcc_logo.jpg'">
                        </div>
                    <div class="card-body">
                        <div class="row align-items-center h-100">
                            <div class="small">
                                <div>
                                <p class="filter-txt"><b><?php echo ucwords($row['name']); ?></b></p>
                                ...
                                <p class="filter-txt">#Contact number: <b><?php echo $row['connected_to'] ?></b></p>
                                    <br>
                                </div>
                            </div>
                        </div>
